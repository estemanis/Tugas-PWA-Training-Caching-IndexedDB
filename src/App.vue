...
import UploadCRUD from './components/Upload CRUD.vue'

import { ref, onMounted } from 'vue';

const dbName = "the_name";
// const customerToAdd = { ssn: "666-66-6666", name: "Alice", age: 28, email: "alice@example.com" };
const customerToAdd = { ssn: "U077821", name: "Steven", age: 22, email: "steven@gmail.com" };
...
// const addRequest = imageStoramge.add({"id": 1, "file": newObjectUrl});
...
<template>
  ...
  <HelloWorld msg="Vite + Vue + MANTAB" />
  <!-- <ReloadPrompt /> -->
  <!-- <FetchPoke/> -->
  <AboutView/>
